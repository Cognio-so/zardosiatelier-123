...
export function PageHero({
  ...
  return (
    <section className="relative h-[58vh] min-h-[420px] overflow-hidden bg-ink sm:h-[62vh]">
      <img src={image} alt="" decoding="async" className="absolute inset-0 h-full w-full object-cover opacity-70" />
...
export function PageShell({ children }: { children: ReactNode }) {
  return <SiteShell><div className="bg-[#F4EFE7]">{children}</div></SiteShell>;
}
