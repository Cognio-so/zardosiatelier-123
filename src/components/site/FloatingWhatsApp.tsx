export function FloatingWhatsApp() {
  return (
    <a
      href="https://wa.me/918826023527?text=Hello%20Maison%20Aur%C3%A9line%2C%20I%27d%20like%20to%20discuss%20a%20couture%20embroidery%20project."
      target="_blank"
      rel="noopener noreferrer"
      aria-label="Chat with us on WhatsApp"
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-white px-5 py-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.35)] ring-1 ring-ink/5 transition-all hover:bg-ink hover:ring-ink"
    >
      <span className="grid size-9 place-items-center rounded-full bg-gold text-white transition-colors group-hover:bg-ivory group-hover:text-ink">
      ...
      <span className="hidden sm:inline text-[10px] uppercase tracking-[0.25em] text-ink transition-colors group-hover:text-ivory">
        WhatsApp
      </span>
    </a>
  );
