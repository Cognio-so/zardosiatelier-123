export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-5 right-5 z-50 flex items-center gap-2 rounded-full border border-[#25D366] bg-[#25D366] pl-2.5 pr-4 py-2 transition-all duration-400 hover:bg-[#20ba5a] hover:scale-105 shadow-lg shadow-black/10"
    >
      {/* White icon badge */}
      <span className="grid size-7 place-items-center rounded-full bg-white/20 text-white transition-colors duration-400 group-hover:bg-white/30 flex-shrink-0">
      ...
      {/* White label text */}
      <span className="hidden sm:inline text-[9px] uppercase tracking-[0.2em] text-white font-semibold">
        WhatsApp
      </span>
    </a>
  );
