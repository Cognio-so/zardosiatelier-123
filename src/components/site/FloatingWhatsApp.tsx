export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-white px-5 py-3 shadow-[0_20px_60px_-20px_rgba(0,0,0,0.35)] ring-1 ring-ink/5 transition-all hover:bg-[#25D366] hover:ring-[#25D366]"
    >
      <span className="grid size-9 place-items-center rounded-full bg-[#25D366] text-white transition-colors group-hover:bg-white group-hover:text-[#25D366]">
      ...
      <span className="hidden sm:inline text-[10px] uppercase tracking-[0.25em] text-ink transition-colors group-hover:text-white">
        WhatsApp
      </span>
    </a>
  );
