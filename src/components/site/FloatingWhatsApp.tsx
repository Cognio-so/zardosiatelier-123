export function FloatingWhatsApp() {
  return (
    <a
      ...
      className="group fixed bottom-6 right-6 z-50 flex items-center gap-3 rounded-full bg-[#FAF7F2] px-5 py-3 shadow-[0_15px_40px_-15px_rgba(0,0,0,0.18)] border border-[#D4AF37]/30 transition-all duration-400 hover:bg-ink hover:border-ink hover:shadow-[0_20px_50px_-15px_rgba(0,0,0,0.3)]"
    >
      <span className="grid size-9 place-items-center rounded-full bg-ink text-[#FAF7F2] transition-colors duration-400 group-hover:bg-[#FAF7F2] group-hover:text-ink">
      ...
      <span className="hidden sm:inline text-[10px] uppercase tracking-[0.25em] text-ink font-medium transition-colors duration-400 group-hover:text-[#FAF7F2]">
        WhatsApp
      </span>
    </a>
  );
